...
<template>
  <div :class="[' mb-4 w-full', containerClass]">
    ...
    />
   <!--  <TipTapEditor v-if="type == 'text_area'" /> -->
    <textarea
      v-if="type == 'text_area'"
      :size="size || 'xl'"
      :value="modelValue"
      ...
      :placeholder="placeholder"
      :class="[
        'w-full resize-none p-3 border border-gray-300 rounded-md text-sm bg-white',
        getHeightClass,
      ]"
    />
  </div>
...
import TipTapEditor from "~/components/organisim/TipTapEditor.vue";
