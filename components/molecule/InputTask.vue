<template>
    <div  class="flex items-center gap-2 p-2" >
        ...
        <input v-if="type === 'checkbox'" type="checkbox" :id="`checkbox-${qIndex}-${oIndex}`" v-model="localIsCorrect" class="hidden peer" />
        ...
        <SelectAtom v-if="type === 'select'" :title="'Answer'" :options="['True', 'False','Not stated']" :label="true" />
        <UInput 
            :model-value="answer"
...
const localIsCorrect = ref(isCorrect);
