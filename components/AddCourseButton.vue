<template>
    ...
    <div class="rounded-lg w-full md:w-4/5 border-primary-color border-2 text-center mt-2 p-1 hover:border-tarawera-700 hover:text-tarawera-700 hover:scale-105 transition-all duration-300">
