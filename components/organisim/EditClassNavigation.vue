<template>
    <ul
        class="fixed text-center  flex-wrap rounded-md p-2 flex w-[80%] mx-auto justify-evenly bottom-6 shadow-lg bg-white left-0 right-0">
...
const icons = [
    ...
    {
        name: 'mingcute:video-fill',
        label: 'Video layout'
    },
    {
        name: 'fluent:text-add-20-filled',
        label: 'Text block'
    },
    {
        name: 'typcn:info',
