<template>
    <div class="shadow-md shadow-fuscous-gray-300 rounded-lg p-2 flex items-center justify-between">
        <InputFile fileType="image" icon="true" title="Main image:" @file-selected="data.image = $event" />
    ...
    <div class="shadow-md shadow-fuscous-gray-300 rounded-lg p-4">
        <div class=" flex items-center justify-between">
            <InputFile fileType="audio" icon="true" title="Auio file:" @file-selected="data.audio = $event" />
            <div class=" flex flex-col justify-between items-center">
